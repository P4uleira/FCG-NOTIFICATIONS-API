...
Execute unit tests
```
    cd "FCG.Notifications.PurchaseConfirmationLambda/test/FCG.Notifications.PurchaseConfirmationLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "FCG.Notifications.PurchaseConfirmationLambda/src/FCG.Notifications.PurchaseConfirmationLambda"
